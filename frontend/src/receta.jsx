...
function RecetaForm() {
    ...
    useEffect(() => {
        ...
        const cargarDatosCompletos = async (cId) => {
            try {
                const resConsulta = await axios.get(`https://consultorio-frontend.onrender.com/api/consultas/${cId}`, config);
                const consultaData = resConsulta.data;
                setConsulta(consultaData);
                const resPaciente = await axios.get(`https://consultorio-frontend.onrender.com/api/pacientes/${consultaData.paciente_id}`, config);
                setPaciente(resPaciente.data);
                const resDoctor = await axios.get(`https://consultorio-frontend.onrender.com/api/usuario/actual`, config);
        ...
        const cargarDatosSimples = async (pId) => {
            try {
                const resPaciente = await axios.get(`https://consultorio-frontend.onrender.com/api/pacientes/${pId}`, config);
                setPaciente(resPaciente.data);
                const resDoctor = await axios.get(`https://consultorio-frontend.onrender.com/api/usuario/actual`, config);
                setDoctor(resDoctor.data);
                setLoading(false);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post('https://consultorio-frontend.onrender.com/api/recetas', datosReceta, config);
